...
To ensure you have the latest and most secure version, we only provide security updates for the latest version of `docs`. We encourage you to always use the most recent release.
...
- Avoid sharing sensitive API keys or credentials in your configuration files or committing them to version control. Use environment variables or a secrets management system instead.
...
We value the contributions from the community and encourage responsible disclosure to help keep `docs` safe and secure for all users.
