---
title: 'Python SDK'
description: 'Get started with the Alchemyst Python SDK'
---

# Alchemyst AI Python SDK
...
response = client.v1.context.add(
    ...
    metadata={
        "file_name": "file_name",
        "doc_type": "type",
        "last_modified_at": "2025-10-02T04:07:26.495484",
        "size": 1234,   # number
        "group_name": ["group1", "group2"]
    }
)
...
results = client.v1.context.search(
    query="find test-data used",
    similarity_threshold=0.8,
    minimum_similarity_threshold=0.5,
    scope="internal",   # internal | external
    metadata={          # Optional - can be None
        "size": 100,
        "doc_type": "ai/conversation",
        "file_name": "chatgpt-convo-1",
        "group_name": ["project-ideas"]
    }
)
```
