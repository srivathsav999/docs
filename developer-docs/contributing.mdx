...
<Frame>
  <img src="/images/pr-merged.png" alt="Screenshot of a deployment confirmation message that says All checks have passed." style={{ borderRadius: '0.5rem' }} />
</Frame>
...
- **Discord Community**: Join our [Discord server](https://discord.gg/QrQTFsTC) for real-time help
